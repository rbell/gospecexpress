...
func (v *validatorBuilder) LengthEquals(length int, options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewLengthEqualsValidator(v.fieldName, v.fieldAlias, length), options...))
	return v
}
...
func (v *validatorBuilder) MaxLength(length int, options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewMaxLengthValidator(v.fieldName, v.fieldAlias, length), options...))
	return v
}
...
func (v *validatorBuilder) MinLength(length int, options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewMinLengthValidator(v.fieldName, v.fieldAlias, length), options...))
	return v
}
...
func (v *validatorBuilder) Contains(thing interface{}, options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewContainsValidator(v.fieldName, v.fieldAlias, thing), options...))
	return v
}
...
func (v *validatorBuilder) ContainsValueFromContext(fromContext interfaces.ValueFromContext, options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewContainsValidatorFromContext(v.fieldName, v.fieldAlias, fromContext), options...))
	return v
}
...
func (v *validatorBuilder) RangeValidate(options ...interfaces.ValidatorOption) interfaces.ValidatorBuilder {
	addFieldValidator(v.validators, v.fieldName, v.fieldAlias, ApplyValidatorOptions(validation.NewRangeValidate(v.fieldName, v.fieldAlias), options...))
	return v
}
